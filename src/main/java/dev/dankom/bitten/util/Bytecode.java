...
import dev.dankom.exception.SyntheticBridgeException;
...
public final class Bytecode {
     ...
     * flags to this enum. The value returned from can then be
     ...
     */
    public static void compareBridgeMethods(MethodNode a, MethodNode b) throws SyntheticBridgeException {
